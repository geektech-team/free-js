...
**Goal:** Bring Free-JS closer to a mature open-source frontend framework by cleaning repository hygiene, stabilizing public API documentation, tightening core types, and splitting the riskiest oversized modules.
